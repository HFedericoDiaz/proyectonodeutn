...
const create = async (req, res) => {
    ...
    if (!duplicado) {
        ...
        send({
            ...
            cuerpo:
            `<h1> Bienvenido ${usuarioFinal.username} a Metalurgica Rivadavia</h1>
            <a href="${process.env.URL_SERVER}:${process.env.PORT}/registro/verify/${usuarioFinal.confirmacionCorreo}">Ingrese al link para activar su registro </a>`,
            });
